...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: 'var(--bg-surface)', borderTop: '1px solid var(--border)', position: 'relative' }}>
      ...
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4" style={{ padding: '20px 24px' }}>
        <p className="text-xs" style={{ fontFamily: 'var(--font-sans)', color: 'var(--text-muted)' }}>
          © 2026 built by harrsh_here
        </p>
        {/* Brighter social icons — #888 default, 18px */}
